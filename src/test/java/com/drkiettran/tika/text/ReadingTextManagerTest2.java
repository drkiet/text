...
public class ReadingTextManagerTest2 {
	public static final Logger logger = LoggerFactory.getLogger(ReadingTextManager2.class);
	...
	public void shouldGetWordsToReadCorrectly() {
		...
		logger.info("transformed: {}", rtm.getTransformed());
	}
}
